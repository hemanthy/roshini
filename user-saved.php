...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v2/user-saved.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 19:23:15 GMT -->
<head>
        ...
        <section class="section page-title-wrapper wb">
            <div class="container">
                <div class="page-title pull-left">
                    <p>This is an subtitle for saved coupons page..</p>
                    <h3>Saved Coupons</h3>
                </div><!-- end title -->
                <div class="pull-right hidden-xs">
                    <div class="bread">
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Saved Coupons</li>
                        </ol>
                    </div><!-- end bread -->
                </div><!-- /.pull-right -->
            </div>
                    ...
                    <div class="sidebar col-md-4">
                        <div class="widget clearfix">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="user-dashboard.php"><span class="glyphicon glyphicon-off"></span>  Dashboard</a></li>
                                <li><a href="user-favorites.php"><span class="fa fa-star"></span>  Favorite Stores</a></li>
                                <li class="active"><a href="user-saved.php"><span class="fa fa-heart-o"></span>  Saved Coupons</a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.php"><img src="uploads/store_01.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.php">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            ...
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 12 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.php"><img src="uploads/store_13.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.php">View Store Coupons</a></small>
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <!-- end coupon-top -->
                                            <h3><a href="coupon-single.php">Greensoil Printable Coupon Code</a></h3>
                            ...
                            <div class="coupon-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 5 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.php"><img src="uploads/store_12.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.php">View Store Coupons</a></small>
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <!-- end coupon-top -->
                                            <h3><a href="coupon-single.php">Follow Skinuque on Facebook get 10% Off</a></h3>
                                ...
                                <div id="code_id_23" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.php">Follow Skinuque on Facebook get 10% Off</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.php"><img src="uploads/store_12.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net/" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                            ...
                            <div class="coupon-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 21 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            ...
                            <div class="coupon-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 51 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            ...
                            <div class="coupon-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 0 Comment</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                ...
                                <div id="code_id_05" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.php">Free Shipping for All Orders</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                            ...
                            <div class="coupon-wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 11 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v2/user-saved.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 19:23:32 GMT -->
</html>