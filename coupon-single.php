...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v2/coupon-single.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 19:23:44 GMT -->
<head>
        ...
        <section class="section page-title-wrapper wb">
            <div class="container">
                <div class="page-title pull-left">
                    <p>This is an subtitle for single coupon.</p>
                ...
                <div class="pull-right hidden-xs">
                    <div class="bread">
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Single Coupon</li>
                        </ol>
                    </div><!-- end bread -->
                </div><!-- /.pull-right -->
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.php"><img src="uploads/store.png" alt="" class="img-responsive"></a>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            ...
                                            <small class="pull-right"><a href="store-single.php"><i class="fa fa-comment-o"></i> 3 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
