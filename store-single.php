                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="coupon-meta">
										...
										<div class="col-md-6 col-sm-4 col-xs-12">
											<a href="#" class="gp-button btn btn-primary">Get Cashback</a>
										 </div>
                                    </div>
                        ...
                        <div class="coupon-tab post-wrapper nopadtop clearfix">
                          ...
                          <!--  <ul class="nav nav-tabs custom-tab-nav" role="tablist">
							...
							<thead class="thead-inverse">
							  ...
							  <tbody>
								<tr>
								  <td>Clothing, Footwear, Fashion Accessories, Watches, Bags-Wallets-Belts, Luggage & Travel, Sunglasses & Eyewear</td>
								  <td>9.5%</td>
								   <td><a href="#" class="btn btn-default btn-block">Get Cashback</a></td>
								</tr>
								<tr>
								  <td>Home Categories (Home & Kitchen Needs, Home Decor, Home Improvement Tools, Home Furnishing)</td>
								  <td>9.5%</td>
								  <td><a href="#" class="gp-button btn btn-primary">Get Cashback</a></td>
								</tr>
								<tr>
								  <td>Larry</td>
								  <td>the Bird</td>
