...
class PhpMailer
{
    ...
    public function send()
    {
        try {
            ...
            if ($this->exceptions) {
            	error_log($exc->getMessage(), 3, require_once __DIR__ ."/php_error.log");
                throw $exc;
            }
            return false;
        }
    ...
    public function postSend()
    {
        try {
        	...
        	error_log($this->Mailer, 3, require_once __DIR__ ."/php_error.log");
            switch ($this->Mailer) {
                case 'sendmail':
                case 'qmail':
    ...
    protected function setError($msg)
    {
    	...
    	error_log($msg, 3, require_once __DIR__ ."/php_error.log");
