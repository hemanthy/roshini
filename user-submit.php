...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v2/user-submit.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 19:23:32 GMT -->
<head>
        ...
        <section class="section page-title-wrapper wb">
            <div class="container">
                <div class="page-title pull-left">
                    <p>This is an subtitle for submit coupon page..</p>
                ...
                <div class="pull-right hidden-xs">
                    <div class="bread">
                        <ol class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Submit Coupon</li>
                        </ol>
                    </div><!-- end bread -->
                </div><!-- /.pull-right -->
            </div>
                    ...
                    <div class="sidebar col-md-4">
                        <div class="widget clearfix">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="user-submit.php"><span class="fa fa-bullhorn"></span>  Submit a Coupon</a></li>
