...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v2/user-favorites.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 19:23:13 GMT -->
<head>
        ...
        <section class="section page-title-wrapper wb">
            <div class="container">
                <div class="page-title pull-left">
                    <p>This is an subtitle for favorite stores page..</p>
                    ...
                    <div class="sidebar col-md-4">
                        <div class="widget clearfix">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="user-favorites.php"><span class="fa fa-star"></span>  Favorite Stores</a></li>
                    ...
                    <div class="sidebar col-md-8">
                        <div class="widget clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.php"><img src="uploads/store_09.jpg" alt="" class="img-responsive"></a>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.php"><img src="uploads/store_10.jpg" alt="" class="img-responsive"></a>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.php"><img src="uploads/store_11.jpg" alt="" class="img-responsive"></a>
...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v2/user-favorites.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Jan 2017 19:23:15 GMT -->
</html>